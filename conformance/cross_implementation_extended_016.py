...
ROOT=Path(__file__).resolve().parents[1]; GO=ROOT/'saga-native-0.16.0'
CASES={
...
(ROOT/'validation/cross-implementation-extended-0.16.0.json').write_text(json.dumps(out,ensure_ascii=False,indent=2)+'\n')
