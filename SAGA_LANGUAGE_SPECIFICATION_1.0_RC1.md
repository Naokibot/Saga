# Saga programming language — Language Specification 1.0 RC1

**Document status:** Release Candidate 1 technical specification for public implementation, independent conformance review, and possible future standards submission.  
**Document identifier:** SAGA-WD-1.0-2026-08-08  
**Normative language version:** 1.0 RC1  
**Primary native implementation version:** 0.14.0  
...
## 21 Records, enumerations, matching and typed results
...
## 22 Interpolated text and tests
...
## 24 Distribution, packages and self-hosting

### 24.1 Native independence
...
### 24.4 Fixed-point self-host compiler
...
## 25 Build targets and optimization

The normative language semantics are independent of code-generation target. Saga Native 0.17.0 defines a deterministic standalone native runtime-AOT profile and a direct scalar WebAssembly profile. The scalar WebAssembly profile is a strict subset and shall reject unsupported Standard Core constructs rather than change their meaning.
...
## 26 Internationalization and diagnostic stability
...
## 27 Release-candidate status

Language Edition 1.0 RC1 freezes the intended Standard Core semantics for independent review. The RC label does **not** claim ISO/IEC approval, international adoption, third-party certification, or target-hardware verification that has not actually occurred. Any change before 1.0 Final that alters a conforming program's meaning shall be documented as a compatibility-affecting defect resolution and receive corresponding conformance tests.
