# Saga programming language — Working Draft 0.9

**Document status:** International Standard candidate working draft.  
**Document identifier:** SAGA-WD-0.9-2026-08-07  
**Normative language version:** 0.9  
**Reference implementation version:** 0.10.0  
...
The normative EBNF is distributed as `spec/saga-0.9.ebnf` and its SHA-256 is recorded in the release checksum manifest.
