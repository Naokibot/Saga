...
`async` and `taskgroup` provide structured hosted concurrency semantics, not a hard-real-time scheduling guarantee. The 4 kHz physical-I/O and certified motion boundaries documented in 0.44 remain unchanged.
